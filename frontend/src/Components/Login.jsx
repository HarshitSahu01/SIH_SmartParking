      ...
      <main className="flex-grow flex flex-col items-center justify-center">
        <div className="w-11/12 max-w-sm bg-white p-6 rounded-lg shadow-lg">
          ...
          <form className="mt-6" onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              className="w-full px-4 py-2 bg-[#003060] text-white font-semibold rounded-md shadow-md hover:bg-[#68BBE3] hover:shadow-lg transition"
            >
              Login
            </button>
          </form>
          <p className="mt-4 text-sm text-center text-gray-600">
            ...
            <Link to="/register" className="text-[#003060] hover:underline">
              Register here
            </Link>
          </p>
        </div>
